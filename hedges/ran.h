 ...
 * @file ran.h
 * @author NC
 * @brief host side HEDGES random functions (CPU side)
 * @copyright Copyright (C) 1992-2007 Numerical Recipes Software
 *            Permission is granted to use this file in association with the
 *            HEDGES DNA Error Correcting Code only For additional permissions
 *            or licenses, see http://numerical.recipes
 */
...
Doub ran_double() { return 5.42101086242752217E-20; }
...
struct Ranbyte {
    ...
    Doub doub() { return 2.32830643653869629E-10 * (int32() + 2.32830643653869629E-10 * int32()); }
};
struct Ranfib {
    Doub dtab[55], dd;
    Int inext, inextp;
...
struct Ranlim32 {
    ...
    inline Doub truedoub() { return 2.32830643653869629E-10 * (int32() + 2.32830643653869629E-10 * int32()); }
};
